...
$moufManager->getConfigManager()->setConstantsDefinitionArray(array (
  ...
  'SECRET' => 
  array (
    'defaultValue' => '1KrGd0xQDUofe1JeusME',
    'type' => 'string',
...
$moufManager->setAllVariables(array (
  'splashDefaultControllersNamespace' => 'ContainerToolBox\\Controllers\\',
  ...
  array (
    ...
    array (
      ...
      array (
        'value' => 
        array (
          0 => '__anonymous__e70c_31756',
          1 => '__anonymous__e70c_10581',
          2 => '__anonymous__e70c_12138',
          3 => '__anonymous__e70c_11355',
          4 => '__anonymous__e70c_22582',
        ),
        'parametertype' => 'object',
        'type' => 'string',
        'metadata' => 
...
',
  ...
  array (
    ...
    'comment' => '',
    'external' => false,
    'code' => 'return Swift_Mailer::newInstance(
        Swift_SmtpTransport::newInstance(SMTP_HOST, SMTP_PORT, SMTP_SECURITY)
...
return new Stash\\Pool($compositeDriver);',
  ...
  'testMailCommand' => 
  array (
    'class' => 'PointTechnique\\Command\\TestMailCommand',
    'external' => false,
    'weak' => false,
    'constructor' => 
    array (
...
return $driver;
			...
			'mailService' => function(ContainerInterface $container) {
...
return rtrim(sys_get_temp_dir(), '/\\').'/mouftwigtemplatemain_'.$posixGetuid.str_replace(":", "", ROOT_PATH);
	 ...
	 */
	 public static function getMailService() {
	 	return MoufManager::getMoufManager()->get('mailService');
	 }
	...
	/**
	 * @return PointTechnique\Command\TestMailCommand
	 */
	 public static function getTestMailCommand() {
	 	return MoufManager::getMoufManager()->get('testMailCommand');
	 }
	 ...
	 */
	 public static function getWelcomeMail() {
	 	return MoufManager::getMoufManager()->get('welcomeMail');
	 }
